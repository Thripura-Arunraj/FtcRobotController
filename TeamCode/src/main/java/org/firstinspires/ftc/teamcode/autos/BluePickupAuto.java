...
@Autonomous(name = "BluePickupAuto", group = "auto")
public class BluePickupAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        color = new Caruso.RectPipeline(165, 180, Caruso.BLUE_PICKUP);
        Movement movement = new Movement();
        Turret turret = new Turret();
        autoTime = new ElapsedTime(ElapsedTime.Resolution.SECONDS);

         c.initCamera(camera1, hardwareMap, color, Caruso.CAMERA_WIDTH, Caruso.CAMERA_HEIGHT, 2);
         c.depoCollect();
        ...
        public void run(){
            try{
                while(!isInterrupted()){
                    ...
                    c.moveDistance(c.LRIGHT, 0.5, STRAFE_DISTANCE, 0, 1.5, c.LeftDistance);
                    ...
                    c.moveDistance(c.LEFT, 0.6, 13, 0, 1.5, c.LeftDistance);

                    //TODO DROP SET AMOUNT
                    c.moveDistance(c.UPLEFT, 0.9, 4, 0, 7, c.LeftDistance);
                    ...
                    c.moveDistance(c.FFORWARD, 0.5, 38, 0, 5, c.FrontDistance);
                    ...
                    c.moveDistance(c.LRIGHT, 0.5, 20, 0, 4, c.LeftDistance);
        ...
        public void run(){
            try{
                while(!isInterrupted()){
                    ...
                    c.magMoveArm(CONFIG, 45, 920, .45, 40);
                    ...
                    c.moveTurret(c.cclock, 160, 0.35);
